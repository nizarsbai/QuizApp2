    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (checkPermissions() == true) {
                    ...
                    try {
                        ...
                        mediaRecorder.start();
                        Toast.makeText(Micro.this, "Recording started", Toast.LENGTH_SHORT).show();
                    ...
                    ActivityCompat.requestPermissions(Micro.this,new String[]{
        ...
        StopRecording.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Micro.this, "Recording stopped", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        StartPlaying.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    mediaPlayer.prepare();
                    mediaPlayer.start();
                    Toast.makeText(Micro.this, "Start playing", Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
        ...
        StopPlaying.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mediaPlayer != null) {
                    ...
                    mediaPlayer.stop();
                    mediaPlayer.release();
                    Toast.makeText(Micro.this, "Stopped playing", Toast.LENGTH_SHORT).show();
                }
            }
        });
